        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><h2><b>Wins Online Shop<b></h2></a>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>Wins</span>-Online Shopp</h2>
              <p>The official shop of Win'sPrelovedBooks & Win's Dresses 💙✨
Browse hidden book-gems here on our shop!</p>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-sm-3">
            <div class="single-widget">
              ...
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="<?php web_root?>index.php?q=profile">Order Status</a></li>
                <li><a href="<?php web_root?>index.php?q=profile">Change Location</a></li>
          ...
          <div class="col-sm-3">
            <div class="single-widget">
              <h2>Policies</h2>
              <ul class="nav nav-pills nav-stacked">
                <li><a href="<?php echo web_root; ?>terms.php">Privecy Policy</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="single-widget">
              <ul class="nav nav-pills nav-stacked">
                        <img src="admin/images/logo.jpg" width="320px" height="250px">
              </ul>
            </div>
          </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Modified by <span><a href="https://www.facebook.com/DANCEVen">Elven Sajorda</a></span></p>
          <p class="pull-right">Designed by <span><a target="_blank" href="#">Group5</a></span></p>
        </div>
      </div>
    </div>
  </footer>
